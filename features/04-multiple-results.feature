Feature: Multiple outcome page
  Scenario: Content on the multiple outcome page
    Given user is on page /frameworks/type/on-going/services-categories/ict/ict-services/cloud
    ...
    And have result card
      ...
      | E2BN                                                                                      |
      | /frameworks/type/on-going/services-categories/ict/ict-services/cloud/ict-cloud            |